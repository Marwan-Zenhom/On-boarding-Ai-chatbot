...
const ArchivedConversationsModal = React.memo(({ isOpen, onClose, conversations, onViewChat, onUnarchive, onDelete }) => {
...
ArchivedConversationsModal.displayName = 'ArchivedConversationsModal';
